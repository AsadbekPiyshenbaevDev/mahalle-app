                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row" style="gap: 10px;justify-content: center;">
                            ...
                            <div class="col-12 col-sm-5 col-lg-5" style="border-bottom: 1px solid rgb(194, 184, 184);">
                                <strong style="color: rgb(194, 184, 184);">{{(strtoupper(substr($family->passport_number,0,2))=='KA' || (strtoupper(substr($family->passport_number,0,2)))=='AD')?"Passport nomer":"Guwalıq nomeri"}}</strong>
                        ...
                        <div class="text-right pt-4" style="padding-right: 80px;">
                            <a href="{{ route('backfamily', ['family' => $family->house_id]) }}"
